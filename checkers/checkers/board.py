...
class Board:
    ...
    def getValidMoves(self, piece):
        ...
        c = piece.color
        if piece.king:
            validmoves.update(self._traverseLeft(rm1, max(rm3, -1), -1, c, piece.col-1))
            validmoves.update(self._traverseRight(rm1, max(rm3, -1), -1, c, piece.col+1))
            validmoves.update(self._traverseLeft(rp1, min(rp3, ROWS), 1, c, piece.col-1))
            validmoves.update(self._traverseRight(rp1, min(rp3, ROWS), 1, c, piece.col+1))
        elif c == RED:
            validmoves.update(self._traverseLeft(rm1, max(rm3, -1), -1, c, piece.col-1))
            validmoves.update(self._traverseRight(rm1, max(rm3, -1), -1, c, piece.col+1))
        elif c == WHITE:
    ...
    #     copyBoard.redLeft = int(str(self.redLeft))
    #     copyBoard.whiteLeft = int(str(self.whiteLeft))
    #     copyBoard.redKings = int(str(self.redKings))
    #     copyBoard.whiteKings = int(str(self.whiteKings))
    #     return copyBoard